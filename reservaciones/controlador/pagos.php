...
if (isset($_GET['id']) && isset($_POST['valor'])) {
    ...
    if ($valorPago > 0) {
        ...
        $consulta = "UPDATE reservacion SET segundo_pago = CASE WHEN segundo_pago IS NULL THEN $valorPago ELSE segundo_pago END,
                     tercer_pago = CASE WHEN segundo_pago IS NOT NULL THEN $valorPago ELSE tercer_pago END
