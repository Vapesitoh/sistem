...
:root {
  ...
  --animation-sentence: 'Te encuentras bien? y como llegaste aqui?';
...
@keyframes showText {
  ...
  99% {
    --animation-sentence: 'Te encuentras bien?\'Se supone que nadie deberia llegar aqui?';
    opacity: 0;
    visibility: hidden;
  }
  100% {
    --animation-sentence: 'Estas mucho tiempo aqui...';
  }
}
@keyframes showNewText {
  ...
  100% {
    --animation-sentence: 'Aun no entiendo\' como haz llegado aqui';
  }
}
...
<div class="container">
  <h1>403</h1>
  <p>Acceso no permitido o no se encontro el sitio a reedireccionar contacte al soporte</p>
  <svg class="keyhole">
    <use href="#keyhole"/>
  </svg>
</div>
...
const rootStyles = getComputedStyle(root);or
...
const grantAccess = () => {
  ...
  heading.textContent = '💤 Imposible 💤';
  paragraph.textContent = 'Accesar';
